...
const detail = `SELECT item.id_item, item.item_name, item.price, item.description, restaurant.restaurant_name, categories.categories_name, item.image FROM item 
